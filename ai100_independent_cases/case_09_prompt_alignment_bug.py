...
def main():
    ...
    for i, entry in enumerate(dataset):
        ...
        # BUG 9: ask for a full sentence even though scoring still assumes one-word labels
        # Original prompt asked for ONLY one word: positive or negative
        prompt = (
            "You are a sentiment classifier.\n"
            "Answer with a full sentence explaining the sentiment in detail.\n\n"
            f"Review:\n{review_text}\n\n"
            "Sentiment:"
        )

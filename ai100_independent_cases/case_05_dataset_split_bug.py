...
def main():
    ...
    model.eval()
        ...
        # BUG 5: use a non-existent split name
    # Original: dataset = load_dataset("imdb", split="test", streaming=True).take(5)
    dataset = load_dataset("imdb", split="testing", streaming=True).take(5)

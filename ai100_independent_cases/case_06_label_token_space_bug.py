...
def main():
    ...
    print("\n--- Starting Inference (Logits Forced Choice) ---")
        ...
        # BUG 6: remove the leading spaces from label tokens
    # Original: pos_ids = tokenizer(" positive", add_special_tokens=False)["input_ids"]
    # Original: neg_ids = tokenizer(" negative", add_special_tokens=False)["input_ids"]
